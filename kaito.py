# encoding=utf8
# Author @Joshua_Ir$A Recoded By Mr.KaitoX
...
os.system("clear")
print('[!] Login Your Facebook Account [!]')
idt = raw_input("[+] Username : ")
